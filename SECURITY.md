...
- **Workspace Root**: `MACRO_WORKSPACE_ROOT` restricts file reads/writes to a specific directory tree
...
https://github.com/xut1021/macro-runner/issues

For sensitive vulnerabilities, email the maintainer directly.
