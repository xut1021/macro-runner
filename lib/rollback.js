...
const MAX_ROLLBACK_FILE_BYTES = parseInt(
  process.env.MACRO_MAX_ROLLBACK_FILE_BYTES || String(10 * 1024 * 1024) // 10 MB
);
const MAX_ROLLBACK_TOTAL_BYTES = parseInt(
  process.env.MACRO_MAX_ROLLBACK_TOTAL_BYTES || String(100 * 1024 * 1024) // 100 MB
);
