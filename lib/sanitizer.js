 ...
 */
// v0.1.8: Key names that likely contain secrets
const SENSITIVE_KEY_RE = /^(api[_-]?key|token|password|passwd|secret|authorization|cookie|credential|private[_-]?key|client[_-]?secret|auth[_-]?token|access[_-]?key)$/i;
